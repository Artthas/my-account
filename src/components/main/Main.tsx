...
function Main(): JSX.Element {
  ...
  return (
    <div>
      ...
      <div className={SCSS['page-content']}>
        <section className={SCSS['catalog']}>
          <h2 className="catalog__title visually-hidden">Catalog</h2>

          <form className={SCSS.form}>
            <svg viewBox="0 0 15 15" width='40px' height='40px' xmlns="http://www.w3.org/2000/svg">
            ...
            <input
              className={SCSS.input} id="search" type="text" autoComplete="off" placeholder="Search"
